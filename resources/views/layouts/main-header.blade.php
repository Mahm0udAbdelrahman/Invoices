                                ...
                                <div class="dropdown-menu">
                                    <div class="menu-header-content bg-primary text-right">
                                        <div class="d-flex">
                                            ...
                                            <a class="badge badge-pill badge-warning mr-auto my-auto float-left" href="{{ route('invoices.Mark_All_Read') }}">Mark All Read</a>
                                        </div>
                                    ...
                                    <div class="main-notification-list Notification-scroll" id="unreadNotifications">
                                        @foreach (auth()->user()->unreadNotifications as $notification)
                                            <a class="d-flex p-3 border-bottom" href="{{ route('invoice_details.edit', $notification->data['id']) }}">
                                                ...
                                                <div class="mr-3">
                                                    ...
                                                    <div class="notification-subtext">
                                                        من: {{ $notification->data['user'] ?? 'Unknown User' }}
                                                    </div>
                                                    <div class="notification-subtext">
