...
@section('title', '  قايمة الفواتير مدفوعه جزئيا ' )
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="invoiceActions">
                                                    ...
                                                    @else
                                                        ...
                                                        <!-- حذف موقت -->
                                                        <a class="dropdown-item text-warning" href="#" data-toggle="modal" data-target="#softDeleteModal"> الارشفه</a>
                                                    @endif
                                                </div>
                                            </div>
