                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <form method="post" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="section_id">
                                    ...
                                    <option @selected($product->section_id ==$section->id) class="form-control" value="{{ $section->id }}"> {{ $section->section_name }} </option>
                                    @endforeach
                        ...
                        <div class="modal-footer">
                            <button class="btn ripple btn-primary">تعديل</button>
                            <a class="btn ripple btn-secondary" href="{{ route('products.index') }}" data-dismiss="modal">اغلاق</a>
                        </div>
